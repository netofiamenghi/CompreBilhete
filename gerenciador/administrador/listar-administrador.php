...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
                ...
                <tbody>
                    ...
                    while ($dados = mysqli_fetch_array($resultado)):
                        ...
                        <tr>
                            ...
                            <td><a class='btn btn-info' href='alterar-administrador.php?id=<?php echo $id ?>'>Alterar</a></td>
                        </tr>
                        <?php
                    endwhile;
                    ?>
            ...
            <a class="btn btn-secondary" href="cadastrar-administrador.php">Inserir</a>
