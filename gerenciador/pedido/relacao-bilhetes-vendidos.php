...
<body>
    <div class="container">
        <h1>Relação de Bilhetes Vendidos</h1>
        <form action="imprimir-relacao-bilhetes-vendidos.php" target="_blank" method="POST">
            ...
            <fieldset>
                ...
                <select name="evento">
                    ...
                    $sql = "select distinct e.id, e.descricao, e.data 
                                from itens_pedido ip, evento_setor es, evento e
                                where es.id = ip.evento_setor_id and es.evento_id = e.id
