...
if (isset($_POST['btnenviar'])):
    ...
    if (empty($descricao)):
        ...
        $sql = "insert into setor (descricao, status) values('$descricao','A')";
        if (mysqli_query($conexao, $sql)):
            $msg[] = "<div class='p-3 mb-2 bg-success text-white'>Setor cadastrado com sucesso!</div>";
        else:
            $msg[] = "<div class='p-3 mb-2 bg-danger text-white'>Erro ao cadastrar Setor: " . mysqli_error($conexao) . "</div>";
        endif;
