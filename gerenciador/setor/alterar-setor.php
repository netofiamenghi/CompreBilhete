...
elseif (isset($_POST['btnenviar'])):
    ...
    if (empty($descricao)):
        ...
        $sql = "update setor set descricao = '$descricao', status = '$status' where id = '$id'";
        if (mysqli_query($conexao, $sql)):
            $msg[] = "<div class='p-3 mb-2 bg-success text-white'>Setor alterado com sucesso!</div>";
        else:
            $msg[] = "<div class='p-3 mb-2 bg-danger text-white'>Erro ao alterar Setor: " . mysqli_error($conexao) . "</div>";
        endif;
        mysqli_close($conexao);
    endif;
endif;
...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <a class="btn btn-secondary" href="listar-setor.php">Listar Setor</a>
